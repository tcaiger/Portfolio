...
function bootstrap_styles()
{
	...
	wp_register_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '3.2.0', 'all' );
	wp_register_style( 'wpbase', get_template_directory_uri() . '/css/wpbase.min.css', array(), '3.2.0', 'all' );
    ...
    wp_register_style( 'responsive-style', get_stylesheet_uri(), false, '3.2.0' );
